...
** Law-based Ecological Information
   ...
   walkable ground, or a climbable tree, specify reliable options to be
   ...
   agents actionably perceive, in terms of what lawful relationships
...
** Convention-based Ecological Information
   ...
   unsuccessfully) on the sound of a can-opener to pursue an
...
** Senters: A Protocol for Joint Attention and Narrative Practice Scaffolding
   ...
   *Specification of PASS*
   ...
   To unpack what has been defined thus far,
     ...
     * A system is a natural or artificial process that behaves
       predictably.
     ...
     * A PASS is here specified generically, so no recommendations
       ...
       defined, though more impoverished in its involvement in
   ...
   *Specification of Senters Protocol*
   ...
   uuid :available] sharing that an instrument is being exercised or
   ...
   To expand on this,
     ...
     * A system event instrumented for engagement of a center indicates
